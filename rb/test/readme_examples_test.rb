...
#      offline in seeded test mode (WebsiteAnalysisApisSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WebsiteAnalysisApis_sdk.rb")
  SDK_CLASS = "WebsiteAnalysisApisSDK"
  ...
  SDK_BASE = "WebsiteAnalysisApis_sdk"
