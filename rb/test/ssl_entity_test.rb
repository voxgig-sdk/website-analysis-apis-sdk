...
class SslEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WEBSITE_ANALYSIS_APIS_TEST_SSL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ssl_basic_setup(extra)
  ...
  entid_env_raw = ENV["WEBSITE_ANALYSIS_APIS_TEST_SSL_ENTID"]
