...
class TechStackEntity
  ...
  def make
    opts = @_entopts.dup
    TechStackEntity.new(@_client, opts)
  end
  ...
  # @return [TechStack, Hash] the current TechStack data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TechStack fields)
  def match_get
  ...
  #
  # @param reqmatch [TechStackListMatch, Hash, nil] match filter (any subset of
  #   TechStack fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<TechStack>, Array] the matching TechStack items; raises WebsiteAnalysisApisError on failure
