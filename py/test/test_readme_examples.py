# WebsiteAnalysisApis SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WebsiteAnalysisApisSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WebsiteAnalysisApisSDK(...) and WebsiteAnalysisApisSDK.test(...) become
#      WebsiteAnalysisApisSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "websiteanalysisapis_sdk"
_SDK_CLASS = "WebsiteAnalysisApisSDK"
