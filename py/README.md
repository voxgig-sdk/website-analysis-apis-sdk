# WebsiteAnalysisApis Python SDK



The Python SDK for the WebsiteAnalysisApis API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Performance()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/website-analysis-apis-sdk/releases)) or
...
| Field | Type | Description |
| --- | --- | --- |
| `screenshotUrl` | `str` | URL to the captured screenshot |
...
| Field | Type | Description |
| --- | --- | --- |
| `foundOn` | `str` | Page where the broken link was found |
| `link` | `str` | The broken link URL |
...
| Field | Type | Description |
| --- | --- | --- |
| `headings` | `dict` | Heading tags analysis |
| `images` | `dict` |  |
| `metaDescription` | `str` | Meta description |
| `score` | `float` | Overall SEO score |
| `timestamp` | `str` | Timestamp of the audit |
...
| `validFrom` | `str` | Certificate valid from date |
| `validTo` | `str` | Certificate expiry date |
...
```
py/
├── websiteanalysisapis_sdk.py         -- Main SDK module
