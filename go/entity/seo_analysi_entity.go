...
type SeoAnalysiEntity struct {
	name    string
	client  *core.WebsiteAnalysisApisSDK
...
func NewSeoAnalysiEntity(client *core.WebsiteAnalysisApisSDK, entopts map[string]any) *SeoAnalysiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SeoAnalysiEntity) GetName() string { return e.name }
...
func (e *SeoAnalysiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SeoAnalysiEntity) Deleted() bool {
	return e.deleted
}


func (e *SeoAnalysiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSeoAnalysiEntity(e.client, opts)
}

func (e *SeoAnalysiEntity) Data(args ...any) any {
...
func (e *SeoAnalysiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SeoAnalysi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SeoAnalysiEntity) DataTyped(data ...SeoAnalysi) SeoAnalysi {
	if len(data) > 0 {
		return typedFrom[SeoAnalysi](e.Data(asMap(data[0])))
	}
	return typedFrom[SeoAnalysi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SeoAnalysi (all fields
// optional at the wire level).
func (e *SeoAnalysiEntity) MatchTyped(match ...SeoAnalysi) SeoAnalysi {
	if len(match) > 0 {
		return typedFrom[SeoAnalysi](e.Match(asMap(match[0])))
	}
	return typedFrom[SeoAnalysi](e.Match())
}
...
func (e *SeoAnalysiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SeoAnalysiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SeoAnalysiLoadMatch and returns an SeoAnalysi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SeoAnalysiEntity) LoadTyped(reqmatch SeoAnalysiLoadMatch, ctrl map[string]any) (SeoAnalysi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return SeoAnalysi{}, err
	}
	return typedFrom[SeoAnalysi](res), nil
}



func (e *SeoAnalysiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SeoAnalysiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SeoAnalysiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SeoAnalysiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SeoAnalysiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
