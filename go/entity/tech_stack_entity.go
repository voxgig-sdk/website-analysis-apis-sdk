...
func NewTechStackEntity(client *core.WebsiteAnalysisApisSDK, entopts map[string]any) *TechStackEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TechStackEntity) GetName() string { return e.name }
...
func (e *TechStackEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TechStackEntity) Deleted() bool {
	return e.deleted
}


func (e *TechStackEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTechStackEntity(e.client, opts)
}

func (e *TechStackEntity) Data(args ...any) any {
...
func (e *TechStackEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TechStack; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TechStackEntity) DataTyped(data ...TechStack) TechStack {
	if len(data) > 0 {
		return typedFrom[TechStack](e.Data(asMap(data[0])))
	}
	return typedFrom[TechStack](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TechStack (all fields
// optional at the wire level).
func (e *TechStackEntity) MatchTyped(match ...TechStack) TechStack {
	if len(match) > 0 {
		return typedFrom[TechStack](e.Match(asMap(match[0])))
	}
	return typedFrom[TechStack](e.Match())
}
...
func (e *TechStackEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TechStackEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TechStackEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TechStackListMatch and returns []TechStack. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TechStackEntity) ListTyped(reqmatch TechStackListMatch, ctrl map[string]any) ([]TechStack, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TechStack](res), nil
}



func (e *TechStackEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TechStackEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TechStackEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TechStackEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
