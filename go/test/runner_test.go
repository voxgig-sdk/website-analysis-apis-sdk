...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("WEBSITEANALYSISAPIS_TEST_LIVE") == "TRUE" ||
		os.Getenv("WEBSITEANALYSISAPIS_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("WEBSITEANALYSISAPIS_TEST_EXPLAIN"); explain != "" {
