...
const testSeed = `map[string]any{"entity": map[string]any{"performance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "screenshot": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "seo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "seo_analysi": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ssl": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tech_stack": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
