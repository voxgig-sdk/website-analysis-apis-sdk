...
class TechStackEntity extends WebsiteAnalysisApisEntityBase_1.WebsiteAnalysisApisEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'tech_stack';
        this.name_ = 'tech_stack';
        this.Name = 'TechStack';
    }
    make() {
        return new TechStackEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<TechStack[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.TechStackEntity = TechStackEntity;
//# sourceMappingURL=TechStackEntity.js.map