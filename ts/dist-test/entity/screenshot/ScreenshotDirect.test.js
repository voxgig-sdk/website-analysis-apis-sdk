...
(0, node_test_1.describe)('ScreenshotDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-screenshot', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-screenshot', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'WEBSITE_ANALYSIS_APIS_TEST_SCREENSHOT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['WEBSITE_ANALYSIS_APIS_TEST_SCREENSHOT_ENTID'];
...
//# sourceMappingURL=ScreenshotDirect.test.js.map