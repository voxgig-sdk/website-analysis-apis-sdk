...
(0, node_test_1.describe)('SeoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-seo', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-seo', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['WEBSITE_ANALYSIS_APIS_TEST_SEO_ENTID'];
...
//# sourceMappingURL=SeoDirect.test.js.map