...
(0, node_test_1.describe)('PerformanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WebsiteAnalysisApisSDK({
    ...
    (0, node_test_1.test)('direct-load-performance', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-performance', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.WEBSITE_ANALYSIS_APIS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'WEBSITE_ANALYSIS_APIS_TEST_PERFORMANCE_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.WebsiteAnalysisApisSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WEBSITE_ANALYSIS_APIS_TEST_PERFORMANCE_ENTID'];
    ...
    const client = new __1.WebsiteAnalysisApisSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PerformanceDirect.test.js.map