...
(0, node_test_1.describe)('TechStackDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-tech_stack', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tech_stack', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['WEBSITE_ANALYSIS_APIS_TEST_TECH_STACK_ENTID'];
...
//# sourceMappingURL=TechStackDirect.test.js.map