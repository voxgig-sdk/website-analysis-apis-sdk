# WebsiteAnalysisApis TypeScript SDK



The TypeScript SDK for the WebsiteAnalysisApis API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Performance()` — each with a small set of operations (`list`, `load`)
...
```ts
new WebsiteAnalysisApisSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `WebsiteAnalysisApisSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `WebsiteAnalysisApisSDK.test(testopts?, sdkopts?)` | `WebsiteAnalysisApisSDK` | Create a test-mode client. |
...
| `client` | `client(): WebsiteAnalysisApisSDK` | Return the parent SDK client. |
...
Create an instance: `const seo_analysi = client.SeoAnalysi()`
...
Create an instance: `const tech_stack = client.TechStack()`
...
├── src/
│   ├── WebsiteAnalysisApisSDK.ts        # Main SDK class
