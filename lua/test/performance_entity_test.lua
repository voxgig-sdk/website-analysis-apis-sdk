...
describe("PerformanceEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set WEBSITE_ANALYSIS_APIS_TEST_PERFORMANCE_ENTID JSON to run live")
      return
    end
...
function performance_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("WEBSITE_ANALYSIS_APIS_TEST_PERFORMANCE_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["WEBSITE_ANALYSIS_APIS_TEST_PERFORMANCE_ENTID"])
