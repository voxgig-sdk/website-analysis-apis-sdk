...
describe("PerformanceEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set WEBSITEANALYSISAPIS_TEST_PERFORMANCE_ENTID JSON to run live")
      return
    end
...
function performance_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("WEBSITEANALYSISAPIS_TEST_PERFORMANCE_ENTID")
