...
local SDK_MODULE = "website-analysis-apis_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["performance"] = { ["test01"] = { id = "test01" } }, ["screenshot"] = { ["test01"] = { id = "test01" } }, ["seo"] = { ["test01"] = { id = "test01" } }, ["seo_analysi"] = { ["test01"] = { id = "test01" } }, ["ssl"] = { ["test01"] = { id = "test01" } }, ["tech_stack"] = { ["test01"] = { id = "test01" } } } }'
