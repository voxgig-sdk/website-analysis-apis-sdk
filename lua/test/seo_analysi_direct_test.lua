...
describe("SeoAnalysiDirect", function()
  it("should direct-load-seo_analysi", function()
    local setup = seo_analysi_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-seo_analysi", setup.live and "live" or "unit")
