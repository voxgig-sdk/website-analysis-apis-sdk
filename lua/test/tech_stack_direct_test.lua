...
describe("TechStackDirect", function()
  it("should direct-list-tech_stack", function()
    local setup = tech_stack_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tech_stack", setup.live and "live" or "unit")
