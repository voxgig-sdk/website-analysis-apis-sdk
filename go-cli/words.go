...
func registerSDKWords(r *eng.Registry, client *sdk.WebsiteAnalysisApisSDK) {
...
func runOp(client *sdk.WebsiteAnalysisApisSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
