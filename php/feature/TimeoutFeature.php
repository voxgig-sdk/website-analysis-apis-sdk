...
// WebsiteAnalysisApis SDK timeout feature
...
class WebsiteAnalysisApisTimeoutFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _with_timeout(WebsiteAnalysisApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WebsiteAnalysisApisContext $_ctx, float $ms): void
    {
        $client = $this->client;
