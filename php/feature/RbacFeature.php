...
// WebsiteAnalysisApis SDK rbac feature
...
class WebsiteAnalysisApisRbacFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _required(WebsiteAnalysisApisContext $ctx): ?string
    {
    ...
    private function _reject(WebsiteAnalysisApisContext $ctx, string $required): void
    {
    ...
    private function _track(WebsiteAnalysisApisContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
