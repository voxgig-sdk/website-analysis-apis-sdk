...
// WebsiteAnalysisApis SDK ratelimit feature
...
class WebsiteAnalysisApisRatelimitFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _acquire(WebsiteAnalysisApisContext $ctx): void
    {
    ...
    private function _track(WebsiteAnalysisApisContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
