...
// WebsiteAnalysisApis SDK telemetry feature
...
class WebsiteAnalysisApisTelemetryFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _close(WebsiteAnalysisApisContext $ctx, bool $ok): void
    {
