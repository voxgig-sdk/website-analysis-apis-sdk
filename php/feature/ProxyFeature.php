...
// WebsiteAnalysisApis SDK proxy feature
...
class WebsiteAnalysisApisProxyFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    public function init(WebsiteAnalysisApisContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WebsiteAnalysisApisContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
