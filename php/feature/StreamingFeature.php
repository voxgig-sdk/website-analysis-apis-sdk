...
// WebsiteAnalysisApis SDK streaming feature
...
class WebsiteAnalysisApisStreamingFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _iterate(WebsiteAnalysisApisResult $result): \Generator
    {
    ...
    private function _streamable(WebsiteAnalysisApisContext $ctx): bool
    {
