...
// WebsiteAnalysisApis SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WebsiteAnalysisApisTestFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    public function init(WebsiteAnalysisApisContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WebsiteAnalysisApisContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WebsiteAnalysisApisParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WebsiteAnalysisApisContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WebsiteAnalysisApisContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = WebsiteAnalysisApisParam::call($ctx, $k);
