...
// WebsiteAnalysisApis SDK TechStack entity
...
class TechStackEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TechStackEntity($this->_client, $opts);
    }

    /**
     * @param TechStack|array $args TechStack data (assoc-array) to store.
     */
    ...
    /**
     * @return TechStack|array The current TechStack data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TechStack fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TechStack fields).
     */
    ...
    /**
     * List TechStack items matching the given filter.
     *
     * @param TechStackListMatch|array|null $reqmatch Match filter (any subset
     *   of TechStack fields) as an assoc-array; TechStackListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TechStack[]|array A list of TechStack items as assoc-arrays at
     *   the SDK boundary; throws WebsiteAnalysisApisError on failure (item-5 convention).
     */
