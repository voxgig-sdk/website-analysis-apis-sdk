...
// WebsiteAnalysisApis SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WebsiteAnalysisApisSDK::test)
...
{
    private const SDK_CLASS = 'WebsiteAnalysisApisSDK';
    ...
    private const SDK_BASE = 'websiteanalysisapis_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../websiteanalysisapis_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
