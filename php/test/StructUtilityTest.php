...
// WebsiteAnalysisApis SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WebsiteAnalysisApisOmni::makeStructRunner(
    ...
    {
        return WebsiteAnalysisApisOmni::objmodel(WebsiteAnalysisApisOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return WebsiteAnalysisApisOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return WebsiteAnalysisApisOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WebsiteAnalysisApisOmni::structfix($now, Struct::undef()))
                        !== json_encode(WebsiteAnalysisApisOmni::structfix($val, Struct::undef()))) {
