...
// WebsiteAnalysisApis SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WebsiteAnalysisApisMakeRequest
{
    public static function call(WebsiteAnalysisApisContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WebsiteAnalysisApisResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WebsiteAnalysisApisResponse($fetched);
        } else {
