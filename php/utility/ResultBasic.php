...
// WebsiteAnalysisApis SDK utility: result_basic

class WebsiteAnalysisApisResultBasic
{
    public static function call(WebsiteAnalysisApisContext $ctx): ?WebsiteAnalysisApisResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof WebsiteAnalysisApisError) ? $result->err->msg : (string)$result->err;
