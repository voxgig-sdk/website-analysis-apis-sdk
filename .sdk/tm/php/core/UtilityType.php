...
// WebsiteAnalysisApis SDK utility type

class WebsiteAnalysisApisUtility
{
    ...
    public static function copy(WebsiteAnalysisApisUtility $src): WebsiteAnalysisApisUtility
    {
        $u = new WebsiteAnalysisApisUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
