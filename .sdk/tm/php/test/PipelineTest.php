...
// WebsiteAnalysisApis SDK pipeline test
//
...
{
    private static function utility(): WebsiteAnalysisApisUtility
    {
        return new WebsiteAnalysisApisUtility();
    }
    ...
    private static function ctx(array $over = []): WebsiteAnalysisApisContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WebsiteAnalysisApisContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WebsiteAnalysisApisOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WebsiteAnalysisApisError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WebsiteAnalysisApisOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WebsiteAnalysisApisMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WebsiteAnalysisApisOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WebsiteAnalysisApisMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WebsiteAnalysisApisOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WebsiteAnalysisApisMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WebsiteAnalysisApisSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WebsiteAnalysisApisMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WebsiteAnalysisApisResponse([]),
            'result' => new WebsiteAnalysisApisResult([]),
        ]);
        [, $err] = WebsiteAnalysisApisMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WebsiteAnalysisApisSpec([]),
            'response' => null,
            'result' => new WebsiteAnalysisApisResult([]),
        ]);
        [, $err] = WebsiteAnalysisApisMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WebsiteAnalysisApisSpec(['step' => 's']),
            'response' => new WebsiteAnalysisApisResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WebsiteAnalysisApisResult([]),
        ]);
        [, $err] = WebsiteAnalysisApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WebsiteAnalysisApisSpec(['step' => 's']),
            'response' => new WebsiteAnalysisApisResponse(self::resp(200, ['v' => 1])),
            'result' => new WebsiteAnalysisApisResult([]),
        ]);
        [, $err] = WebsiteAnalysisApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WebsiteAnalysisApisSpec(['step' => 's']),
            'response' => new WebsiteAnalysisApisResponse(self::resp(200, ['v' => 2])),
            'result' => new WebsiteAnalysisApisResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WebsiteAnalysisApisMakeResponse::call($ctx);
    ...
    {
        $preset = new WebsiteAnalysisApisResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WebsiteAnalysisApisSpec([]),
            'response' => new WebsiteAnalysisApisResponse([]),
            'result' => new WebsiteAnalysisApisResult([]),
        ...
        [$got, $err] = WebsiteAnalysisApisMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WebsiteAnalysisApisResult([])]);
        [, $err] = WebsiteAnalysisApisMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WebsiteAnalysisApisSpec([]), 'result' => null]);
        [, $err] = WebsiteAnalysisApisMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WebsiteAnalysisApisSpec(['step' => 's']),
            'result' => new WebsiteAnalysisApisResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WebsiteAnalysisApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WebsiteAnalysisApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WebsiteAnalysisApisSpec(['step' => 's']),
            'result' => new WebsiteAnalysisApisResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WebsiteAnalysisApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WebsiteAnalysisApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WebsiteAnalysisApisResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WebsiteAnalysisApisSpec([]),
            'result' => new WebsiteAnalysisApisResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WebsiteAnalysisApisMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WebsiteAnalysisApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WebsiteAnalysisApisError('boom', 'boom');
        $utility->fetcher = function (WebsiteAnalysisApisContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WebsiteAnalysisApisSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WebsiteAnalysisApisMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WebsiteAnalysisApisContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WebsiteAnalysisApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WebsiteAnalysisApisResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WebsiteAnalysisApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WebsiteAnalysisApisContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WebsiteAnalysisApisSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WebsiteAnalysisApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WebsiteAnalysisApisResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WebsiteAnalysisApisSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WebsiteAnalysisApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WebsiteAnalysisApisMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WebsiteAnalysisApisMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WebsiteAnalysisApisResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WebsiteAnalysisApisDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WebsiteAnalysisApisResult(['ok' => false])]);
        $this->expectException(WebsiteAnalysisApisError::class);
        WebsiteAnalysisApisDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WebsiteAnalysisApisResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WebsiteAnalysisApisMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WebsiteAnalysisApisMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WebsiteAnalysisApisBaseFeature();
        $b = new WebsiteAnalysisApisBaseFeature();
        WebsiteAnalysisApisFeatureAdd::call($ctx, $a);
        WebsiteAnalysisApisFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WebsiteAnalysisApisBaseFeature
    {
        $f = new WebsiteAnalysisApisBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WebsiteAnalysisApisFeatureAdd::call($ctx, self::named_feature('a'));
        WebsiteAnalysisApisFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        WebsiteAnalysisApisFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        WebsiteAnalysisApisFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        WebsiteAnalysisApisFeatureAdd::call($ctx, $replace);
        ...
        WebsiteAnalysisApisFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WebsiteAnalysisApisContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WebsiteAnalysisApisSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WebsiteAnalysisApisPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WebsiteAnalysisApisPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WebsiteAnalysisApisResponse(['headers' => null]),
            'result' => new WebsiteAnalysisApisResult([]),
        ]);
        WebsiteAnalysisApisResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WebsiteAnalysisApisResultBody::call($ctx);
