...
// WebsiteAnalysisApis SDK audit feature
...
class WebsiteAnalysisApisAuditFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _emit(WebsiteAnalysisApisContext $ctx, string $outcome): void
    {
