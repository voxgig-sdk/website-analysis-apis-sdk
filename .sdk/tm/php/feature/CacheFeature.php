...
// WebsiteAnalysisApis SDK cache feature
...
class WebsiteAnalysisApisCacheFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _through(WebsiteAnalysisApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
