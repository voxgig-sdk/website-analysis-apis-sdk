...
// WebsiteAnalysisApis SDK netsim feature
...
class WebsiteAnalysisApisNetsimFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    private function _simulate(WebsiteAnalysisApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WebsiteAnalysisApisContext $ctx, array $applied): void
    {
        $client = $this->client;
