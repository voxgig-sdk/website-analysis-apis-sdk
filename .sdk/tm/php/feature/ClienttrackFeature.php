...
// WebsiteAnalysisApis SDK clienttrack feature
...
class WebsiteAnalysisApisClienttrackFeature extends WebsiteAnalysisApisBaseFeature
{
    ...
    public function PostConstruct(WebsiteAnalysisApisContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WebsiteAnalysisApis-SDK';
