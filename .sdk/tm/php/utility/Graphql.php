...
// WebsiteAnalysisApis SDK utility: graphql
//
...
class WebsiteAnalysisApisGraphql
{
    ...
    // equivalent.
    public static function body(WebsiteAnalysisApisContext $ctx): mixed
    {
    ...
    public static function errors(WebsiteAnalysisApisContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
