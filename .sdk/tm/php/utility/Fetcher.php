...
// WebsiteAnalysisApis SDK utility: fetcher

class WebsiteAnalysisApisFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WebsiteAnalysisApisSDK/1.0)';
    ...
    public static function call(WebsiteAnalysisApisContext $ctx, string $fullurl, array $fetchdef): array
    {
