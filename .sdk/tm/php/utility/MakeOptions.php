...
// WebsiteAnalysisApis SDK utility: make_options

class WebsiteAnalysisApisMakeOptions
{
    ...
    public static function call(WebsiteAnalysisApisContext $ctx): array
    {
        ...
        //
        // `WebsiteAnalysisApisSchema::optspec()` is built from the model:
        ...
        $optspec = WebsiteAnalysisApisSchema::optspec();
