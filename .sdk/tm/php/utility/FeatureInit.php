...
// WebsiteAnalysisApis SDK utility: feature_init

class WebsiteAnalysisApisFeatureInit
{
    public static function call(WebsiteAnalysisApisContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
