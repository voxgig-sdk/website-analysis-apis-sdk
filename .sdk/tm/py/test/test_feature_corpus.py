# WebsiteAnalysisApis SDK feature corpus test
#
...
def _client(kase):
    ...
    WebsiteAnalysisApisSDK(...), not WebsiteAnalysisApisSDK.test(...): the `test` feature is
    ...
    return WebsiteAnalysisApisSDK(opts)
