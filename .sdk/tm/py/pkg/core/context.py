...
from projectname_sdk.core.control import WebsiteAnalysisApisControl
...
class WebsiteAnalysisApisContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WebsiteAnalysisApisControl()
        ...
        if isinstance(sp, WebsiteAnalysisApisSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WebsiteAnalysisApisResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WebsiteAnalysisApisResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WebsiteAnalysisApisOperation({})
        ...
        op = WebsiteAnalysisApisOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return WebsiteAnalysisApisError(code, msg, self)
