...
|---|---|---|
| `ts/` | @voxgig-sdk/website-analysis-apis-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/website-analysis-apis-sdk \
      --repository voxgig-sdk/website-analysis-apis-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/website-analysis-apis-sdk` shows it, and
`npm trust revoke @voxgig-sdk/website-analysis-apis-sdk --id=<id>` removes it.
