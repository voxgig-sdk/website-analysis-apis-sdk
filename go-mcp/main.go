// Command WebsiteAnalysisApis-mcp is an MCP server exposing the WebsiteAnalysisApis
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WebsiteAnalysisApis_list  — list records of an entity
//	WebsiteAnalysisApis_load  — load a single record of an entity
//
