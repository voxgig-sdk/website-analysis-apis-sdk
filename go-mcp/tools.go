...
type Args struct {
	Entity string         `json:"entity" jsonschema:"performance | screenshot | seo | seo_analysi | ssl | tech_stack"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WebsiteAnalysisApisSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "website-analysis-apis_list",
		Description: "List records from WebsiteAnalysisApis. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "website-analysis-apis_load",
		Description: "Load a single record from WebsiteAnalysisApis. " +
...
func runOp(client *sdk.WebsiteAnalysisApisSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WebsiteAnalysisApisSDK, name string) (sdk.WebsiteAnalysisApisEntity, error) {
	...
	case "seo_analysi":
		return client.SeoAnalysi(nil), nil
	case "ssl":
		return client.Ssl(nil), nil
	case "tech_stack":
		return client.TechStack(nil), nil
